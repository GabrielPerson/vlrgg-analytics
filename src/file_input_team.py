...
import pandas
from output_excel import TeamMapDataExcel
from output_csv import TeamMapDataCSV 
...
if output_type.lower() == 'csv':
    ...
    TeamMapDataCSV(urls, output_file)
elif output_type.lower() == 'xls':
    output_file = '../data/excel/' + output_file
    TeamMapDataExcel(urls, output_file, ['TEAM DATA'])
else:
